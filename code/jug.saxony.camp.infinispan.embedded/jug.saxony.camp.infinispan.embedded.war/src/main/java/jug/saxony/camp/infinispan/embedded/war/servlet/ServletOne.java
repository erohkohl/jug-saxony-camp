package jug.saxony.camp.infinispan.embedded.war.servlet;
...
import jug.saxony.camp.infinispan.embedded.jar.logic.Service;
...
public class ServletOne extends HttpServlet {
	...
	private final String subsubtitle = "<h6>JCache API und benutzerdefiniertem Interceptor</h6>";
